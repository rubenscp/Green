...
public class ProcessingResultEntity {
	...
	public enum Code {
		...
		// Possible resultas of the SITIS experiment form
		EXPERIMENT_ERROR_NO_TEAM_MEMBERS_IN_DATABASE(200), //
		EXPERIMENT_ERROR_NO_VARIABLES_IN_DATABASE(201), //
		EXPERIMENT_ERROR_NO_TREATMENTS_IN_DATABASE(202), //
		EXPERIMENT_ERROR_NO_RAFFLES_IN_DATABASE(203), //
		EXPERIMENT_INFORMATION_SUCCESS_DELETE_EXPERIMENT(210), //
		EXPERIMENT_ERROR_DELETE_EXPERIMENT_INVALID_STATUS(211), //
		EXPERIMENT_ERROR_EXPERIMENT_HAS_SCHEDULES(212), //
