...
public class ProcessingResultEntity {
	...
	public enum Code {
		...
		// Email services
		EMAIL_SERVICE_ERROR_INITIALIZING(70), //
		EMAIL_SERVICE_ERROR_FORMATTER(71), //
		EMAIL_SERVICE_ERROR_SEND(72), //

		// Possible results of I/O Operations
		IO_OPERATION_WRITE_FILE(50), //
		...
		// Possible results of the list of GREEN experiments
		...
		// Possible results of the GREEN experiment form
		...
		EXPERIMENT_ERROR_NO_TITLE(203), //
		EXPERIMENT_ERROR_NO_DESCRIPTION(204), //

		// Possible results of GREEN experiment services
		// EXPERIMENT_SERVICE_INFORMATION_SUCCESS(210), //
		// EXPERIMENT_SERVICE_EXCEPTION_FINDALL(211), //

		// Possible results of the GREEN image of experiment
		IMAGE_INFORMATION_SUCCESS_UPLOAD_IMAGE(300), //
		IMAGE_INFORMATION_SUCCESS_UPDATE_IMAGE(301), //
		IMAGE_INFORMATION_SUCCESS_DELETE_IMAGE(302), //
